    ...
    <div className="min-h-screen w-full bg-[#fdfbf7] flex flex-col items-center justify-start sm:justify-center py-12 px-6 font-sans">
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-[2.5rem] shadow-xl shadow-stone-900/5 border border-stone-100 p-8 sm:p-10">
          {error && (
            <p className="text-red-500 text-xs mb-6 text-center bg-red-50 py-3 px-4 rounded-xl border border-red-100 italic">
              {error}
            </p>
          )}
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            <div className="space-y-1">
              ...
              <input 
                ...
                className="w-full px-6 py-4 bg-stone-50 border border-stone-100 rounded-2xl outline-none focus:ring-2 focus:ring-[#1a4f8b]/20 text-stone-800 transition-all text-base"
